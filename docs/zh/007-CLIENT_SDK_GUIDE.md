...
| `basic-auth-context-client/web` + `/react` | redirect-contract focused root tests、External-consumer scenario、standalone minimal entry example、query/hash-bearing browser-route forwarding focused web tests、dedicated React provider/hook focused test | 更广泛 browser host 语义仍未验证 |
