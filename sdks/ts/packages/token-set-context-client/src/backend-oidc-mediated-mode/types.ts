...
// types that do not depend on OIDC-mediated sealed flow specifics.
//
...
export const BackendOidcMediatedModeContextSource = {
	Client: "token_set_context_client",
	Persistence: "token-set-context",
} as const;

export type BackendOidcMediatedModeContextSource =
	(typeof BackendOidcMediatedModeContextSource)[keyof typeof BackendOidcMediatedModeContextSource];

export const BackendOidcMediatedModeStateRestoreSourceKind = {
	Manual: "manual",
	PersistentStore: "persistent_store",
} as const;

export type BackendOidcMediatedModeStateRestoreSourceKind =
	(typeof BackendOidcMediatedModeStateRestoreSourceKind)[keyof typeof BackendOidcMediatedModeStateRestoreSourceKind];
...
export interface BackendOidcMediatedModeAuthorizeQuery {
	postAuthRedirectUri?: string;
}
...
export interface BackendOidcMediatedModeClientConfig {
	/** Base URL of the SecurityDept server. */
	baseUrl: string;
	/** Path to login/authorize endpoint (default: "/auth/oidc-mediated/login"). */
	loginPath?: string;
	/** Path to callback page (default: "/auth/oidc-mediated/callback"). */
	callbackPath?: string;
	/** Path to token refresh endpoint (default: "/auth/oidc-mediated/refresh"). */
	refreshPath?: string;
	/** Path to metadata redemption endpoint (default: "/auth/oidc-mediated/metadata/redeem"). */
