...
import { freshBearerHeader, mergeTokenDelta } from "../token/token-ops";
import type { AuthDelta, AuthSnapshot } from "../token/types";
import { createAuthorizedTransport } from "../transport/auth-transport";
