...
This project is indexed by GitNexus as **securitydept** (9611 symbols, 19938 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
