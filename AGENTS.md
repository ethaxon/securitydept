...
This project is indexed by GitNexus as **securitydept** (8767 symbols, 18553 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
