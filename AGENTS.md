...
This project is indexed by GitNexus as **securitydept** (9648 symbols, 19948 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
